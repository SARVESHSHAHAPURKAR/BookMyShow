...
public class BookMyShow {
    ...
    private void createTheatre() {
        ...
        theatreController.addTheatres(City.BANGALORE, Collections.singletonList(inoxTheatre));
        theatreController.addTheatres(City.DELHI, Collections.singletonList(pvrTheatre));
    ...
    private void createMovies() {
        ...
        movieController.addMovies(City.BANGALORE, Collections.singletonList(avengers));
        movieController.addMovies(City.DELHI, Collections.singletonList(avengers));
        movieController.addMovies(City.BANGALORE, Collections.singletonList(baahubali));
        movieController.addMovies(City.DELHI, Collections.singletonList(baahubali));
    }
